/* Curated public CA roots for user/httpsget (generated from the Mozilla bundle,
 * plus three ECDSA P-384 roots fetched directly from their issuers in 15.1).
 * Public certificates -- safe to commit. 5 RSA + 3 ECDSA P-384 roots: the latter
 * exercise the same ecdsa_p384_verify() path used for CertificateVerify, so a
 * server whose *chain* (not just its leaf signature) is ECDSA P-384 throughout
 * is now trustable -- previously such a chain would dead-end at an RSA-only root. */
#pragma once
static const unsigned char ca_root_0[] = { /* ISRG Root X1 (RSA, 1391B) */
...
static const unsigned char ca_root_1[] = { /* DigiCert Global Root G2 (RSA, 914B) */
...
static const unsigned char ca_root_2[] = { /* DigiCert Global Root CA (RSA, 947B) */
...
static const unsigned char ca_root_3[] = { /* USERTrust RSA Certification Authority (RSA, 1506B) */
...
static const unsigned char ca_root_4[] = { /* GTS Root R1 (RSA, 1371B) */
...
static const unsigned char ca_root_5[] = { /* ISRG Root X2 (ECDSA P-384, 543B) */
...
static const unsigned char ca_root_6[] = { /* GTS Root R3 (ECDSA P-384, 525B) */
...
static const unsigned char ca_root_7[] = { /* GTS Root R4 (ECDSA P-384, 525B) */
    0x30, 0x82, 0x02, 0x09, 0x30, 0x82, 0x01, 0x8e, 0xa0, 0x03, 0x02, 0x01,
...
static const struct { const unsigned char *der; unsigned len; const char *name; } ca_roots[] = {
    { ca_root_0, sizeof ca_root_0, "ISRG Root X1" },
    { ca_root_1, sizeof ca_root_1, "DigiCert Global Root G2" },
    { ca_root_2, sizeof ca_root_2, "DigiCert Global Root CA" },
    { ca_root_3, sizeof ca_root_3, "USERTrust RSA Certification Authority" },
    { ca_root_4, sizeof ca_root_4, "GTS Root R1" },
    { ca_root_5, sizeof ca_root_5, "ISRG Root X2" },
    { ca_root_6, sizeof ca_root_6, "GTS Root R3" },
    { ca_root_7, sizeof ca_root_7, "GTS Root R4" },
};
