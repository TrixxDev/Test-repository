...
TLS_U_SRC := crypto/sha256.c crypto/sha384.c crypto/hmac_sha256.c crypto/hkdf.c crypto/chacha20.c \
             ...
             http2/frame.c http2/settings.c http2/data.c http2/hpack.c http2/headers.c
...
# + DATA + HPACK-compressed HEADERS, static table only).
.PHONY: h2-test
h2-test:
	$(CC) -O2 -Ihttp2 tools/h2_test.c http2/frame.c http2/settings.c http2/data.c http2/hpack.c http2/headers.c -o /tmp/aurora_h2_test
	/tmp/aurora_h2_test
