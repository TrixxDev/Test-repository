...
# (15.9) is the RFC 6265 cookie jar.
...
user/httpsget.elf: user/httpsget.c user/url.o user/cookiejar.o user/ca_roots.h user/libc.h user/crt0.o $(LIBC_OBJ) $(TLS_U_OBJ) user/user.ld
	$(CC) $(UCFLAGS) -Icrypto -Itls -Ix509 -Icompress -c user/httpsget.c -o user/httpsget.o
	$(LD) -m elf_i386 -no-pie -T user/user.ld user/crt0.o user/httpsget.o user/url.o user/cookiejar.o $(TLS_U_OBJ) $(LIBC_OBJ) -o $@
