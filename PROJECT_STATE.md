...
[docs/STABILITY.md](docs/STABILITY.md)); **v1.1.0** grows the desktop environment,
starting with a complete window model — **minimize (window-shade) and maximize**
(a `WM_RESIZE` resize protocol) on top of close/focus/drag. It is an early
